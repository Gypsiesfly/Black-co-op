  ...
  return (
    <div className={`min-h-screen bg-white ${passionOne.variable}`} suppressHydrationWarning>
      ...
      <section className="relative" suppressHydrationWarning>
        ...
        <div className="relative z-10 py-8 sm:py-12 px-4" suppressHydrationWarning>
          <div className="max-w-5xl mx-auto" suppressHydrationWarning>
            <div
              className={`bg-black rounded-2xl overflow-hidden transition-all duration-1000 ${
                true ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
              suppressHydrationWarning
            >
              <div className="px-6 sm:px-12 py-8 sm:py-16" suppressHydrationWarning>
                <div className="flex flex-col md:flex-row justify-between items-start mb-8 sm:mb-16" suppressHydrationWarning>
                  {/* Left side - Title and button */}
                  <div
                    className={`mb-8 md:mb-0 transition-all duration-1000 delay-100 ${
                  ...
                  <div
                    ...
                    suppressHydrationWarning
                  >
                    <div className="mb-4 sm:mb-6 flex flex-col items-center" suppressHydrationWarning>
                      <div className="bg-[#FFCC00] p-2 sm:p-3 w-[50px] sm:w-[60px] h-[50px] sm:h-[60px] flex items-center justify-center mb-1" suppressHydrationWarning>
                        <Image src="/images/site-icon.png" alt="BLACK CO-OP" width={40} height={40} />
                      </div>
                      <div className="text-[6px] text-white text-center leading-tight" suppressHydrationWarning>
                        ADVANCING BLACK-LED
                        <br />
                        COOPERATIVE
                        <br />
                ...
                <div className="border-t border-white pt-4 flex flex-col md:flex-row justify-between items-center" suppressHydrationWarning>
                  <p className="text-xs text-white"> 2023 — COPYRIGHT</p>
                  <div className="flex gap-4 text-xs text-white mt-2 md:mt-0" suppressHydrationWarning>
                    <span>GER</span>
                    <span>SPA</span>
                    <span>SWE</span>
